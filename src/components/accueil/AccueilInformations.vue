...
<template>
  <QList bordered>
    ...
    <AccueilVolet label="Mention d'information">
      ...
      <p>
        Les données collectées seront conservées sur les serveurs du département
        de mathématiques pendant une période de 5 ans et ne seront communiquées
        à aucun service extérieur.
      </p>
      La confidentialité des données est de deux types :
      <ol>
        <li>
          Vos vœux (principaux et secondaires) et vos attributions de services
          seront visibles par l’ensemble des intervenants dans les enseignements
          de mathématiques.
        </li>
        <li>
          Vos modifications de services (décharges, délégations, etc.) et les
          commentaires à l’attention de la commission d’attribution des services
          ne seront visibles que par les membres de cette commission.
        </li>
      </ol>
      <p>
        ...
        vos données. Vous pouvez également retirer à tout moment votre
        consentement au traitement de vos données. Consultez le site
        <a
      ...
      <p>
        ...
        données dans ce dispositif, vous pouvez contacter le directeur du
