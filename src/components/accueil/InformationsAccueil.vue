...
import VoletAccueil from "@/components/accueil/VoletAccueil.vue";
</script>

<template>
  <QCard bordered flat square>
    <QList>
      <VoletAccueil label="Guide d'utilisation">
      ...
      <VoletAccueil label="Mention d'information">
        <p>
