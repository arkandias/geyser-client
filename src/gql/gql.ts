...
const documents = {
  ...
  "\n  query GetCoursesTableRows($year: Int!) {\n    courses: enseignement(\n      where: {\n        _and: [\n          { annee: { _eq: $year } }\n          { heures_corrigees: { _gt: 0 } }\n          { groupes_corriges: { _gt: 0 } }\n        ]\n      }\n      order_by: [\n        { mention: { cursus: { nom: asc } } }\n        { mention: { nom: asc } }\n        { parcours: { nom: asc } }\n        { semestre: asc }\n        { nom: asc }\n        { type: asc }\n      ]\n    ) {\n      ...CourseRow\n    }\n  }\n":
    types.GetCoursesTableRowsDocument,
  ...
  "\n  fragment RequestDetails on demande {\n    id\n    teacher: intervenant {\n      ...Profile\n    }\n    course: enseignement {\n      id\n      hoursPerGroup: heures_corrigees\n    }\n    requestType: type\n    hours: heures\n    weightedHours: heures_eqtd\n    isPriority: prioritaire\n  }\n\n  fragment TotalRequestHours on demande_aggregate {\n    aggregate {\n      sum {\n        hours: heures\n      }\n    }\n  }\n\n  fragment TotalRequestWeightedHours on demande_aggregate {\n    aggregate {\n      sum {\n        weightedHours: heures_eqtd\n      }\n    }\n  }\n":
  ...
  "\n  query GetTeachersTableRows($year: Int!, $where: intervenant_bool_exp = {}) {\n    teachers: intervenant(\n      where: { _and: [{ services: { annee: { _eq: $year } } }, $where] }\n      order_by: [{ nom: asc }, { prenom: asc }]\n    ) {\n      ...TeacherRow\n    }\n  }\n":
    types.GetTeachersTableRowsDocument,
