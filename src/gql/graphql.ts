...
export type TeacherCoursesFragment = { __typename?: 'service', teacher: { __typename?: 'intervenant', uid: string, alias?: string | null, firstname: string, lastname: string }, requests: Array<{ __typename?: 'demande', type: string, courseId: number, hours: number }> } & { ' $fragmentName'?: 'TeacherCoursesFragment' };
