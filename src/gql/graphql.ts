...
export type AdminServiceModificationTeacherFragment = { __typename?: 'Teacher', uid: string, firstname: string, lastname: string, alias?: string | null } & { ' $fragmentName'?: 'AdminServiceModificationTeacherFragment' };
