...
export type AdminTeacherFragment = { __typename?: 'Teacher', uid: string, firstname: string, lastname: string, alias?: string | null, position?: string | null, baseServiceHours?: number | null, visible: boolean, active: boolean } & { ' $fragmentName'?: 'AdminTeacherFragment' };
