...
export type ComputeServicePrioritiesArgs = {
  s?: InputMaybe<Scalars['service_scalar']['input']>;
};

export type ComputeYearPrioritiesArgs = {
  year_param?: InputMaybe<Scalars['Int']['input']>;
};
...
export type SetCurrentPhaseMutation = { __typename?: 'mutation_root', phase?: { __typename?: 'Phase', value: string } | null };
...
export type PriorityFormDataFragment = { __typename?: 'Course', priorityRule?: number | null, courseId: number } & { ' $fragmentName'?: 'PriorityFormDataFragment' };
