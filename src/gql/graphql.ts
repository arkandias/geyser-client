...
export enum PhaseConstraint {
  ...
  UniqueCurrentPhase = 'unique_current_phase'
}
...
export type AdminPriorityFragment = { __typename?: 'Priority', id: number, year: number, seniority?: number | null, isPriority?: boolean | null, computed: boolean, service: { __typename?: 'Service', id: number, uid: string }, course: { __typename?: 'Course', id: number, name: string, semester: number, program: { __typename?: 'Program', id: number, name: string, nameDisplay?: string | null, degree: { __typename?: 'Degree', id: number, name: string, nameDisplay?: string | null } }, track?: { __typename?: 'Track', id: number, name: string } | null, type: { __typename?: 'CourseType', id: number, label: string } } } & { ' $fragmentName'?: 'AdminPriorityFragment' };

export type AdminPrioritiesServiceFragment = { __typename?: 'Service', id: number, year: number, uid: string } & { ' $fragmentName'?: 'AdminPrioritiesServiceFragment' };

export type AdminPrioritiesCourseFragment = { __typename?: 'Course', id: number, year: number, name: string, semester: number, program: { __typename?: 'Program', name: string, degree: { __typename?: 'Degree', name: string } }, track?: { __typename?: 'Track', name: string, program: { __typename?: 'Program', name: string, degree: { __typename?: 'Degree', name: string } } } | null, type: { __typename?: 'CourseType', label: string } } & { ' $fragmentName'?: 'AdminPrioritiesCourseFragment' };
...
export type AdminRequestFragment = { __typename?: 'Request', id: number, year: number, type: string, hours: number, service: { __typename?: 'Service', id: number, uid: string }, course: { __typename?: 'Course', id: number, name: string, semester: number, program: { __typename?: 'Program', id: number, name: string, nameDisplay?: string | null, degree: { __typename?: 'Degree', id: number, name: string, nameDisplay?: string | null } }, track?: { __typename?: 'Track', id: number, name: string } | null, type: { __typename?: 'CourseType', id: number, label: string } } } & { ' $fragmentName'?: 'AdminRequestFragment' };
...
export type RequestCardDataFragment = { __typename?: 'Request', id: number, year: number, type: string, hours: number, isPriority?: boolean | null, service?: { __typename?: 'VService', id?: number | null, teacher?: { __typename?: 'Teacher', displayname?: string | null } | null } | null, course: { __typename?: 'Course', id: number, hoursPerGroup?: number | null } } & { ' $fragmentName'?: 'RequestCardDataFragment' };
...
export const TeacherServiceRequestsFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"TeacherServiceRequests"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Service"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","alias":{"kind":"Name","value":"assignment"},"name":{"kind":"Name","value":"requests"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"where"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"type"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"_eq"},"value":{"kind":"StringValue","value":"assignment","block":false}}]}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"hoursWeighted"}}]}},{"kind":"Field","alias":{"kind":"Name","value":"primary"},"name":{"kind":"Name","value":"requests"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"where"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"type"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"_eq"},"value":{"kind":"StringValue","value":"primary","block":false}}]}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"hoursWeighted"}}]}},{"kind":"Field","alias":{"kind":"Name","value":"secondary"},"name":{"kind":"Name","value":"requests"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"where"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"type"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"_eq"},"value":{"kind":"StringValue","value":"secondary","block":false}}]}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"hoursWeighted"}}]}}]}}]} as unknown as DocumentNode<TeacherServiceRequestsFragment, unknown>;
