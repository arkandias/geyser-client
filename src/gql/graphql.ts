...
export type GetAdminTeachersQuery = { __typename?: 'query_root', teachers: Array<(
    ...
    { __typename?: 'Position' }
    & { ' $fragmentRefs'?: { 'AdminTeacherPositionFragment': AdminTeacherPositionFragment } }
  )> };
